  ...
  return (
    <div className="inset-y-0 left-0 overflow-hidden">
      <Image
        ...
        height={height / 2}
        objectFit="contain"
        style={{ minWidth : width /1.8 , minHeight : height / 2 , zIndex: 0}}
      />
    </div>
  );
};
  ...
  return (
    <div className="flex h-screen bg-gray-900">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8">
        ...
        <button type="button" className="text-white bg-slate-800 hover:bg-slate-700 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-[92px] py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55  mb-4">
          ...
          <span className="ml-2">Sign in with Intra</span>
        </button>
        ...
        <div className="mt-4 font-semibold text-sm text-slate-500 mr-28 text-center md:text-left">
          Don't have an account? <a className="text-cyan-200 hover:underline hover:underline-offset-4" href="/sign-up">Register</a>
        </div>
      </div>
    </div>
  );
